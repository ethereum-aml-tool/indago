...
if __name__ == "__main__":
    ...
    parser.add_argument('--gas_price_file', default=None, type=str, help='path to gas price address sets')
    parser.add_argument('--multi_denom_file', default=None, type=str, help='path to gas price address sets')
